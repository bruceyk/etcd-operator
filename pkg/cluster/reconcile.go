...
func (c *Cluster) removeDeadMember(toRemove *etcdutil.Member) error {
	...
	_, err := c.eventsCli.Create(context.Background(), k8sutil.ReplacingDeadMemberEvent(toRemove.Name, c.cluster), metav1.CreateOptions{})
	if err != nil {
...
func (c *Cluster) removeMember(toRemove *etcdutil.Member) (err error) {
	...
	_, err = c.eventsCli.Create(context.Background(), k8sutil.MemberRemoveEvent(toRemove.Name, c.cluster), metav1.CreateOptions{})
	if err != nil {
